        ...
        <nav class="navbar navbar-expand-xl navbar-custom fixed-top">
                    ...
                    <div class="col-lg-6 d-none d-xl-block">
                        <ul class="navbar-nav justify-content-center">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link <?php echo e(request()->routeIs('artikel') ? 'active' : ''); ?>" href="<?php echo e(route('artikel')); ?>">Artikel</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('hubungi') ? 'active' : ''); ?>" href="<?php echo e(route('hubungi')); ?>">Hubungi Kami</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="collapse navbar-collapse d-xl-none" id="navbarNav">
                 <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('artikel') ? 'active' : ''); ?>" href="<?php echo e(route('artikel')); ?>">Artikel</a></li>
                    <li class="nav-item"><a class="nav-link <?php echo e(request()->routeIs('hubungi') ? 'active' : ''); ?>" href="<?php echo e(route('hubungi')); ?>">Hubungi Kami</a></li>
