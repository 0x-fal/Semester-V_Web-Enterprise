...
<section class="hero-section">
    <div class="hero-image">
        <img src="<?php echo e(asset('images/picgedung.png')); ?>" alt="Building" class="w-100">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-3 col-sm-6">
                <div class="mitra-logo">
                    <img src="<?php echo e(asset('images/aviation.jpg')); ?>" alt="Education Partner" class="img-fluid">
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="mitra-logo">
                    <img src="<?php echo e(asset('images/adrew.png')); ?>" alt="St Andrews College" class="img-fluid">
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="mitra-logo">
                    <img src="<?php echo e(asset('images/htw.png')); ?>" alt="NTW College" class="img-fluid">
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="mitra-logo">
                    <img src="<?php echo e(asset('images/studygroup.png')); ?>" alt="Study Group" class="img-fluid">
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="article-card">
                        <img src="<?php echo e(asset('images/studijerman.png')); ?>" alt="Article 1" class="article-image article-1">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="article-card">
                        <img src="<?php echo e(asset('images/korona.png')); ?>" alt="Article 2" class="article-image article-2">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="article-card">
                        <img src="<?php echo e(asset('images/bahasajerman.png')); ?>" alt="Article 3" class="article-image article-3">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="article-card">
                        <img src="<?php echo e(asset('images/gatescambride.png')); ?>" alt="Article 4" class="article-image article-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/miharu/Documents/Mercu Buana Sem.5/Kamis/Enterprise/Project_Satu/resources/views/home.blade.php ENDPATH**/ ?>